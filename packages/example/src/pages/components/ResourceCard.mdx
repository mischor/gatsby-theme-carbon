...
### Important: formatting around image link line
In the examples, you will see markdown image inclusion syntax.  To make the markdown work within the `ResourceCard` tag, you **must**
* start the markdown in column 1, 2, or 3, and
* have a new line (with no blanks/tabs) in front of, and behind the markdown line.
* have the final `ResourceCard` closing tag start in column 1, 2, or 3 (if you start it in 4 or more, it is interpreted as markdown syntax for a code snippet).
